<x-layout>
    ...
    <div class="card-body" style="background-color: #979797;">
        <div class="container">
            <h4 class="text-center mt-4">Profile Anda<br/></h4>
                            ...
                            <div class="row">
                                <div class="col-md-4" >
                                    ...
                                    <div class="text-center">
                                        <img src="{{ asset('assets/img/photo2.png') }}" class="img-fluid" alt="Profile Image">
                                    </div>
                                </div>
                                <div class="col-md-8">
